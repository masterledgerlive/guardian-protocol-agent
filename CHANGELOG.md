...
- GAME catalog freeze is **sticky** (`0x1C4CcA7C5DB003824208aDDA61Bd749e55F463a3`). Desk-confirmed Uni V3 WETH fee-3000 pool `0x70fbffe313d4a40909dba7129e0b2f4a45a645b5` `liquidity()=0` (ghost); liquid book is Uni V2 GAME/VIRTUAL. Factory `liquidity=0` fees are skipped **before** QuoterV2. No `FREEZE_GAME` env — `/unfreeze` and `OPERATOR_BUY` cannot reopen new buys. Sells/exits stay open. Inject hitch surfaces other than GAME stay live.
