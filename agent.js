...
// ═══════════════════════════════════════════════════════════════════════════════
// ⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v15.5
// ═══════════════════════════════════════════════════════════════════════════════
...
` : ``}` +
    ...
    for (const src of activeSources) {
      ...
      const proceeds = await executeSell(
        cdp, src.token, RIPPLE_SELL_PCT,
        `🌊 RIPPLE — pooling for ${targetNames}`, src.price, false
      );
      if (proceeds > 0) {
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════");
  console.log("⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v15.5");
  ...
  console.log("      v15.5: 🌊 Ripple Engine — coordinated multi-stale cascade + Kahuna flood mode");
  ...
  await tg(
    `⚔️💓 <b>GUARDIAN v15.5 — HEARTBEAT EDITION ONLINE</b>\n\n` +
