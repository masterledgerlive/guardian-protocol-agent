...
// ═══════════════════════════════════════════════════════════════════════════════
// ⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v15.6
// ═══════════════════════════════════════════════════════════════════════════════
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════");
  console.log("⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v15.6");
  ...
  console.log("      v15.6: WELL disabled (Aerodrome), ETH/WETH auto-manager, Kahuna flood 2/3 sell");
  ...
  await tg(
    `⚔️💓 <b>GUARDIAN v15.6 — HEARTBEAT EDITION ONLINE</b>\n\n` +
