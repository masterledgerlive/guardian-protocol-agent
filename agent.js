...
// ═══════════════════════════════════════════════════════════════════════
// ⚔️  GUARDIAN CASCADE SYSTEM v11.6 — PEAK EXIT EDITION
// ═══════════════════════════════════════════════════════════════════════
...
async function processToken(cdp, token, ethBal) {
  try {
    ...
    console.log(`  │ 🪙 ${balDisp} ($${(balance*price).toFixed(2)}) | mom:${mom.direction}(${mom.pct.toFixed(3)}%) slowing:${slowing}`);
...
async function main() {
  console.log("═══════════════════════════════════════════════════════");
  console.log("⚔️   GUARDIAN CASCADE SYSTEM v11.6 — PEAK EXIT EDITION");
  console.log("═══════════════════════════════════════════════════════\n");
