...
// ═══════════════════════════════════════════════════════════════════════════════
// ⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v14.8
// ═══════════════════════════════════════════════════════════════════════════════
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════");
  console.log("⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v14.8");
  ...
  console.log("      v14.8: drawdown threshold raised 35%->60% | lets bot trade through normal dips");
  ...
  await tg(
    `⚔️💓 <b>GUARDIAN v14.8 — HEARTBEAT EDITION ONLINE</b>\n\n` +
