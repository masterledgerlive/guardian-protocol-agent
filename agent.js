...
const STALE_WINDOW_MS      = 20 * 60_000; // 20 minutes of no movement = stale (was 25)
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════");
  console.log("⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v14.0");
  ...
  const BATCH2_SYMBOLS = ["ZORA","BNKR","TYBG","MIGGLES","NORMIE","BENJI","ROOST","TALENT"];
