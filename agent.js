...
const DEFAULT_TOKENS = [
  ...
  // KITE — gokite.ai, AI infrastructure on Base, Coinbase listed, user holding at entry ~$0.30
...
async function processToken(cdp, token, bal) {
  try {
    ...
    // Allow buy if: at trough, armed, have funds, cooldown clear
    ...
    const shouldBuy    = atMinTrough && arm.armed && !atMaxPosition && !shouldSell
