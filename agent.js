...
// ═══════════════════════════════════════════════════════════════════════════════
// ⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v14.9
// ═══════════════════════════════════════════════════════════════════════════════
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════");
  console.log("⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v14.9");
  ...
  console.log("      v14.9: fix stopLossHit init order | XCN trend-ride logic");
  ...
  await tg(
    `⚔️💓 <b>GUARDIAN v14.9 — HEARTBEAT EDITION ONLINE</b>\n\n` +
