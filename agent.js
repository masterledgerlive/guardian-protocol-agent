...
// ═══════════════════════════════════════════════════════════════════════════════
// ⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v14.6
// ═══════════════════════════════════════════════════════════════════════════════
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════");
  console.log("⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v14.6");
  ...
  console.log("      v14.6: RPC hang fix | cached balance/gas | no more processToken timeouts");
  ...
  await tg(
    `⚔️💓 <b>GUARDIAN v14.6 — HEARTBEAT EDITION ONLINE</b>\n\n` +
