...
// ═══════════════════════════════════════════════════════════════
// GUARDIAN CASCADE SYSTEM v7.8 — PERSISTENT POSITIONS
//
// HOW IT WORKS:
...
async function sendReport(ethBalance) {
  ...
  await sendAlert(
    `📊 <b>GUARDIAN CASCADE v7.8 — 30 MIN REPORT</b>\n\n` +
...
async function main() {
  console.log("═══════════════════════════════════════════════════");
  console.log("⚔️   GUARDIAN CASCADE SYSTEM v7.8 — PERSISTENT POSITIONS");
  console.log("═══════════════════════════════════════════════════\n");
  ...
  await sendAlert(
    `⚔️ <b>GUARDIAN CASCADE v7.8 — STARTED</b>\n\n` +
  ...
  while (true) {
    try {
      ...
      await checkTelegramCommands(cdp, eth);
