...
// ═══════════════════════════════════════════════════════════════════════════════
// ⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v15.4
// ═══════════════════════════════════════════════════════════════════════════════
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════");
  console.log("⚔️💓  GUARDIAN PROTOCOL — HEARTBEAT EDITION v15.4");
  ...
  console.log("      v15.4: AIXBT fee tier 3000→10000 — was routing to wrong/empty pool causing all reverts");
  ...
  await tg(
    `⚔️💓 <b>GUARDIAN v15.4 — HEARTBEAT EDITION ONLINE</b>\n\n` +
