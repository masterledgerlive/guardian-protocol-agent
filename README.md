...
- **Capital-fit** (`capital-fit.js`): Coinbase wraps / majors catalog. **CBBTC/AAVE** are slow at RISK size (~$4–10) — no new buys until ~$40+ book; thin bags recycle into primed **UNI/LINK/AERO** so capital is not locked on BTC-speed margins. WBTC skipped (use CBBTC); CBETH stays watchlist.
