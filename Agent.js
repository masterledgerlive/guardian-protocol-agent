...
async function runGuardianAgent() {
  ...
  const agent = createReactAgent({
    llm,
    tools,
    messageModifier: "You are the Guardian Protocol Agent on Base Sepolia testnet. Report wallet address, network, and balance clearly.",
  });
  ...
  console.log("Guardian Protocol Agent - COMPLETE.");
}
