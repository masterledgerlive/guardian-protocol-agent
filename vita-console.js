...
function helpText() {
  return [
    ...
    "/vitafeed [text|file|brain|backlog|enqueue|next|dir|unlock|kids|music] — VITAFILE; DOS dir; KIDS url dir; MUSIC grouped song; open-source unlock; files|play|keys; confirm|override → /vita/feed-player · /vita/kids-player · ?music=maple",
