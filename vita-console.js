...
function helpText() {
  return [
    ...
    "/vitafeed [text|file|brain|backlog|enqueue|next|dir|unlock|kids] — VITAFILE; DOS dir; KIDS url dir; open-source unlock; files|play|keys; confirm|override → /vita/feed-player · /vita/kids-player",
