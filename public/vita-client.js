...
function helpText() {
  return [
    ...
    "/vitafeed [text|file|brain|learn|proof|load|know|recall|cipher|backlog|enqueue|next|dir|unlock|dual|translate|kids|music|board|pad|prompt] exact/VITAFILE/mind; DOS dir; KIDS url directory; PD MUSIC library grouped VIN; DJ soundboard pads; dual lanes; loader packs; open-source unlock; files|play|keys; confirm|override; /vita/players/garden · /vita/players/proven · /vita/feed-player · /vita/kids-player?dir=kids · /vita/soundboard · /vita/feed-player?music=maple&kids=1 · /vita/feed-loader",
